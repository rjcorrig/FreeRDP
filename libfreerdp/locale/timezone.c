...
{
	{ 633031380000000000ULL, 180000000000ULL, 0, { 0, 1, 0, 1, 0, 0 }, { 0, 1, 0, 1, 0, 0 }, }
};
...
{
	{ 633031380000000000ULL, 180000000000ULL, 60, { 0, 2, 0, 2, 2, 0 }, { 0, 11, 0, 1, 0, 0 }, },
	{ 633346740000000000ULL, 633032244000000000ULL, 60, { 0, 2, 0, 5, 0, 0 }, { 0, 10, 0, 2, 0, 0 }, },
	{ 633662964000000000ULL, 633347604000000000ULL, 60, { 0, 2, 0, 3, 0, 0 }, { 0, 10, 6, 3, 23, 59 }, },
	...
	{ 643445172000000000ULL, 643130676000000000ULL, 60, { 0, 2, 6, 4, 23, 59 }, { 0, 10, 6, 3, 23, 59 }, },
...
{
	{ 633662964000000000ULL, 180000000000ULL, 60, { 0, 10, 0, 5, 2, 0 }, { 0, 4, 0, 1, 2, 0 }, },
...
{
	{ 633031380000000000ULL, 180000000000ULL, 60, { 0, 3, 0, 2, 2, 0 }, { 0, 9, 0, 2, 2, 0 }, },
	{ 633346740000000000ULL, 633032244000000000ULL, 60, { 0, 3, 0, 2, 2, 0 }, { 0, 10, 0, 1, 2, 0 }, },
	{ 633662964000000000ULL, 633347604000000000ULL, 60, { 0, 3, 0, 2, 2, 0 }, { 0, 10, 0, 1, 2, 0 }, },
	{ 633978324000000000ULL, 633663828000000000ULL, 60, { 0, 3, 0, 2, 2, 0 }, { 0, 10, 0, 1, 2, 0 }, },
	{ 634293684000000000ULL, 633979188000000000ULL, 60, { 0, 3, 0, 2, 2, 0 }, { 0, 10, 0, 1, 2, 0 }, },
	{ 634609044000000000ULL, 634294548000000000ULL, 60, { 0, 3, 0, 2, 2, 0 }, { 0, 10, 0, 1, 2, 0 }, },
	{ 634925268000000000ULL, 634609908000000000ULL, 60, { 0, 3, 0, 2, 2, 0 }, { 0, 10, 0, 1, 2, 0 }, },
	{ 635240628000000000ULL, 634926132000000000ULL, 60, { 0, 3, 0, 2, 2, 0 }, { 0, 10, 0, 1, 2, 0 }, },
	{ 635555988000000000ULL, 635241492000000000ULL, 60, { 0, 3, 0, 2, 2, 0 }, { 0, 10, 0, 1, 2, 0 }, },
...
static const TIME_ZONE_RULE_ENTRY TimeZoneRuleTable_32[] =
{
	...
	{ 634925268000000000ULL, 634609908000000000ULL, 60, { 0, 10, 0, 5, 1, 0 }, { 0, 3, 0, 5, 2, 0 }, },
	{ 3155378292000000000ULL, 634926132000000000ULL, 60, { 0, 10, 0, 5, 1, 0 }, { 0, 3, 0, 5, 0, 0 }, }
};
...
static const TIME_ZONE_RULE_ENTRY TimeZoneRuleTable_34[] =
{
	...
	{ 3155378292000000000ULL, 635872212000000000ULL, 60, { 0, 10, 0, 5, 3, 0 }, { 0, 3, 0, 5, 2, 0 }, }
	{ 3155378292000000000ULL, 635872212000000000ULL, 60, { 0, 10, 0, 5, 4, 0 }, { 0, 3, 0, 5, 3, 0 }, }
};
...
static const TIME_ZONE_RULE_ENTRY TimeZoneRuleTable_61[] =
{
	...
	{ 634293684000000000ULL, 633979188000000000ULL, 60, { 0, 9, 1, 3, 23, 59 }, { 0, 3, 6, 3, 23, 59 }, },
	{ 634609044000000000ULL, 634294548000000000ULL, 60, { 0, 9, 1, 3, 23, 59 }, { 0, 3, 6, 3, 23, 59 }, },
	{ 634925268000000000ULL, 634609908000000000ULL, 60, { 0, 9, 1, 3, 23, 59 }, { 0, 3, 6, 3, 23, 59 }, },
	{ 635240628000000000ULL, 634926132000000000ULL, 60, { 0, 9, 1, 3, 23, 59 }, { 0, 3, 6, 3, 23, 59 }, },
	{ 635555988000000000ULL, 635241492000000000ULL, 60, { 0, 9, 1, 3, 23, 59 }, { 0, 3, 6, 3, 23, 59 }, },
	{ 635871348000000000ULL, 635556852000000000ULL, 60, { 0, 9, 1, 3, 23, 59 }, { 0, 3, 6, 3, 23, 59 }, },
	{ 636187572000000000ULL, 635872212000000000ULL, 60, { 0, 9, 2, 3, 23, 59 }, { 0, 3, 0, 3, 23, 59 }, },
	{ 636502932000000000ULL, 636188436000000000ULL, 60, { 0, 9, 4, 3, 23, 59 }, { 0, 3, 2, 3, 23, 59 }, },
	{ 636818292000000000ULL, 636503796000000000ULL, 60, { 0, 9, 5, 3, 23, 59 }, { 0, 3, 3, 3, 23, 59 }, },
	{ 637133652000000000ULL, 636819156000000000ULL, 60, { 0, 9, 6, 3, 23, 59 }, { 0, 3, 4, 3, 23, 59 }, },
	{ 637449876000000000ULL, 637134516000000000ULL, 60, { 0, 9, 0, 3, 23, 59 }, { 0, 3, 5, 3, 23, 59 }, },
	{ 637765236000000000ULL, 637450740000000000ULL, 60, { 0, 9, 2, 3, 23, 59 }, { 0, 3, 0, 3, 23, 59 }, },
	{ 638080596000000000ULL, 637766100000000000ULL, 60, { 0, 9, 3, 3, 23, 59 }, { 0, 3, 1, 3, 23, 59 }, },
	{ 638395956000000000ULL, 638081460000000000ULL, 60, { 0, 9, 4, 3, 23, 59 }, { 0, 3, 2, 3, 23, 59 }, },
...
static const TIME_ZONE_RULE_ENTRY TimeZoneRuleTable_107[] =
{
	...
	{ 634609044000000000ULL, 634294548000000000ULL, 60, { 0, 4, 0, 1, 1, 0 }, { 0, 9, 0, 5, 0, 0 }, },
	{ 3155378292000000000ULL, 634609908000000000ULL, 60, { 0, 4, 0, 1, 1, 0 }, { 0, 9, 0, 5, 0, 0 }, }
};
...
static const TIME_ZONE_ENTRY TimeZoneTable[] =
{
	...
	{
		"SA Pacific Standard Time", 1140, FALSE, "(UTC-05:00) Bogota, Lima, Quito, Rio Branco",
		"SA Pacific Standard Time", "SA Pacific Daylight Time",
		NULL, 0
	},
	{
		"Eastern Standard Time (Mexico)", 1140, FALSE, "(UTC-05:00) Chetumal",
	...
	},
	{
		...
		(TIME_ZONE_RULE_ENTRY*) &TimeZoneRuleTable_16, 2
	},
	{
		"Venezuela Standard Time", 1170, TRUE, "(UTC-04:30) Caracas",
		"Venezuela Standard Time", "Venezuela Daylight Time",
		(TIME_ZONE_RULE_ENTRY*) &TimeZoneRuleTable_17, 1
	},
	{
		"Paraguay Standard Time", 1200, TRUE, "(UTC-04:00) Asuncion",
		"Paraguay Standard Time", "Paraguay Daylight Time",
		(TIME_ZONE_RULE_ENTRY*) &TimeZoneRuleTable_18, 14
	},
	{
	...
	},
	{
		...
		(TIME_ZONE_RULE_ENTRY*) &TimeZoneRuleTable_20, 35
	},
	{
	...
	{
		"Argentina Standard Time", 1260, TRUE, "(UTC-03:00) City of Buenos Aires",
		"Argentina Standard Time", "Argentina Daylight Time",
		(TIME_ZONE_RULE_ENTRY*) &TimeZoneRuleTable_25, 3
	},
	{
	...
	},
	{
		...
		(TIME_ZONE_RULE_ENTRY*) &TimeZoneRuleTable_28, 2
	},
	{
		"Pacific SA Standard Time", 1260, TRUE, "(UTC-03:00) Santiago",
		"Pacific SA Standard Time", "Pacific SA Daylight Time",
		(TIME_ZONE_RULE_ENTRY*) &TimeZoneRuleTable_29, 8
	},
	{
	...
	{
		"Mid-Atlantic Standard Time", 1320, TRUE, "(UTC-02:00) Mid-Atlantic - Old",
	...
	},
	{
		...
		(TIME_ZONE_RULE_ENTRY*) &TimeZoneRuleTable_32, 3
	},
	{
		"Cape Verde Standard Time", 1380, FALSE, "(UTC-01:00) Cabo Verde Is.",
	...
	},
	{
		...
		(TIME_ZONE_RULE_ENTRY*) &TimeZoneRuleTable_34, 9
	},
	{
	...
	},
	{
		...
		(TIME_ZONE_RULE_ENTRY*) &TimeZoneRuleTable_36, 1
	},
	{
	...
	},
	{
		...
		(TIME_ZONE_RULE_ENTRY*) &TimeZoneRuleTable_41, 1
	},
	{
	...
	},
	{
		...
		(TIME_ZONE_RULE_ENTRY*) &TimeZoneRuleTable_52, 7
	},
	{
...
const WINDOWS_TZID_ENTRY WindowsTimeZoneIdTable[] =
{
	...
	{ "Central Pacific Standard Time", "Pacific/Bougainville" },
	...
	{ "N. Central Asia Standard Time", "Asia/Novosibirsk Asia/Omsk" },
	...
	{ "Pacific Standard Time", "America/Tijuana America/Santa_Isabel" },
	...
	{ "SA Eastern Standard Time", "America/Fortaleza America/Araguaina America/Belem America/Maceio America/Recife America/Santarem" },
	...
	{ "SA Western Standard Time", "America/Grand_Turk" },
